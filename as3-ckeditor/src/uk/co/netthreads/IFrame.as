...
// -----------------------------------------------------------------------
//
//Edits by Wouter Verweirder, www.happy-banana.be
//made frameId protected
//added change flags for content and source properties
//added 'px' to the positioning function of the iframe
//
	            ...
	            "{" +
                    ...
                    "{" +
                        "document.getElementById(frameID).innerHTML = \"<iframe id='\"+iframeID+\"' src='\"+url+\"' onLoad='"
                        	+ FlexGlobals.topLevelApplication.id + ".\"+frameID+\"_load()' name='" + FlexGlobals.topLevelApplication.id + ".\"+frameID+\"' frameborder='0'></iframe>\";" + 
                    "}" +
                "}" +
            "}";
